...
<body>
    ...
    <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#ffe6ff;">
        <div class="row">
            <div class="col-sm-3 mt-2">
                ...
                <div class="container-fluid rounded bg-light p-2 mt-2 mb-2" >
                    <div class="container rounded mt-2 mb-2 border" style="background-color:  #ffe6ff; font-size:larger;">
            ...
            <div class="col-sm-6 mt-2">
                ...
                <div class="container-fluid rounded bg-light mt-2 mb-2 p-2">
                    ...
                    <div class="container rounded mt-2 mb-2 border" style="background-color:#ffe6ff;">
                        <div class="container mt-2">
        ...
        <footer id="footer">
            <div class="container-fluid text-center rounded bg-light p-2">
                ...
                <div class="credits">
                    Designed by <a href="https://bootstrapmade.com/">Shriram R</a>
                </div>
            </div>
        </footer>
    </div>
